...
#pragma pack(4)
	...
	typedef struct {
		...
		vm_address_t address;
		vm_size_t size;
	} __Request___kernelrpc_vm_read_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack()
#endif
...
#pragma pack(4)
	...
	typedef struct {
		...
		vm_prot_t max_protection;
		vm_inherit_t inheritance;
	} __Request___kernelrpc_vm_map_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack()
#endif
...
#pragma pack(4)
	...
	typedef struct {
		...
		boolean_t copy;
		vm_inherit_t inheritance;
	} __Request___kernelrpc_vm_remap_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack()
#endif
...
union __RequestUnion__vm_map_subsystem {
	...
	__Request___kernelrpc_vm_read_t Request__kernelrpc_vm_read;
	...
	__Request___kernelrpc_vm_map_t Request__kernelrpc_vm_map;
	__Request__vm_machine_attribute_t Request_vm_machine_attribute;
	__Request___kernelrpc_vm_remap_t Request__kernelrpc_vm_remap;
...
#pragma pack(4)
	...
	typedef struct {
		...
		NDR_record_t NDR;
		mach_msg_type_number_t dataCnt;
	} __Reply___kernelrpc_vm_read_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack()
#endif
...
#pragma pack(4)
	...
	typedef struct {
		...
		kern_return_t RetCode;
		vm_address_t address;
	} __Reply___kernelrpc_vm_map_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack()
#endif
...
#pragma pack(4)
	...
	typedef struct {
		...
		vm_prot_t cur_protection;
		vm_prot_t max_protection;
	} __Reply___kernelrpc_vm_remap_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack()
#endif
...
#define subsystem_to_name_map_vm_map \
    ...
    { "_kernelrpc_vm_map", 3812 },\
    { "vm_machine_attribute", 3813 },\
    { "_kernelrpc_vm_remap", 3814 },\
    { "task_wire", 3815 },\
