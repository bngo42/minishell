...
#endif
	typedef __Request___kernelrpc_vm_read_t __Request;
	typedef __Reply___kernelrpc_vm_read_t Reply __attribute__((unused));
...
#pragma pack()
	...
	OutP->RetCode = vm_write(In0P->Head.msgh_request_port, In0P->address, (vm_offset_t)(In0P->data.address), In0P->data.size);
...
#endif
	typedef __Request___kernelrpc_vm_map_t __Request;
	typedef __Reply___kernelrpc_vm_map_t Reply __attribute__((unused));
...
#endif
	typedef __Request___kernelrpc_vm_remap_t __Request;
	typedef __Reply___kernelrpc_vm_remap_t Reply __attribute__((unused));
...
#endif
	typedef __Request__vm_map_64_t __Request;
	typedef __Reply__vm_map_64_t Reply __attribute__((unused));
